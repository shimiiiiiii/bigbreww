...
<div class="card-body">
<form action="{{ url('expenses/'.$expenses->expenses_id.'/edit') }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="expenses_name" id="expenses_name" value="{{ $expenses->expenses_name }}"/>
    ...
    @error('type_id') <span class="text-danger">{{ $message }}</span> @enderror
        ...
        <div class="mb-3">
            ...
            <input type="text" name="quantity" id="quantity" value="{{ $expenses->quantity }}"/>
            @error('quantity') <span class="text-danger">{{ $message }}</span> @enderror
        </div>
        <div class="mb-3">
            <label for="expenses_price">Expense Price</label>
            <input type="text" name="expenses_price" id="expenses_price" value="{{ $expenses->expenses_price }}"/>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="expenses_date" id="expenses_date" value="{{ $expenses->expenses_date }}" readonly/>
